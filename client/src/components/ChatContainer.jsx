...
const ChatContainer = ({ selectedUser, setSelectedUser }) => {
  ...
  return selectedUser ? (
    <div className='h-full overflow-hidden relative backdrop-blur-lg flex flex-col'>
      ...
      {/*-----Chat Messages----- */}
      <div className='flex-1 flex flex-col overflow-y-auto no-scrollbar p-3 pb-6'>
    ...
    <div className='flex flex-col items-center justify-center text-gray-500 gap-2 bg-white/10 max-md:hidden'>

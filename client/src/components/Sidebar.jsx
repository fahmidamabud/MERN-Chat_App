...
const Sidebar = ({ selectedUser, setSelectedUser }) => {
  ...
  return (
    <div className={`bg-[#8185b2]/10 h-full p-5 rounded-r-xl overflow-y-auto no-scrollbar text-white ${selectedUser ? "max-md:hidden" : ''}`}>
      <div className='pb-5'>
        <div className='flex justify-between items-center'>
          <img src={assets.big_logo} alt="logo" className='max-w-15' />
